(() => {
    ...
    function menuInit() {
        ...
        document.addEventListener("click", (function(e) {
            ...
            const its_menuOpenButton = target == menuOpenButton || menuOpenButton.contains(target);
            const menuBody_is_active = document.documentElement.classList.contains("menu-open");
            if (!its_menuBody && !its_menuOpenButton && menuBody_is_active) functions_menuClose();
        }));
        for (const menuItem of menuItems) menuItem.addEventListener("click", (() => {
            functions_menuClose();
        }));
    }
    function menuOpen() {
    ...
    function handleScroll() {
        ...
        if (scrollPosition >= 50) document.body.classList.add("scrolled"); else document.body.classList.remove("scrolled");
    }
